...
import (
	...
	samplecrdv1 "github.com/zhhnzw/k8s-demo/crd_demo/pkg/apis/samplecrd/v1"
	clientset "github.com/zhhnzw/k8s-demo/crd_demo/pkg/client/clientset/versioned"
	networkscheme "github.com/zhhnzw/k8s-demo/crd_demo/pkg/client/clientset/versioned/scheme"
	informers "github.com/zhhnzw/k8s-demo/crd_demo/pkg/client/informers/externalversions/samplecrd/v1"
	listers "github.com/zhhnzw/k8s-demo/crd_demo/pkg/client/listers/samplecrd/v1"
)
...
func NewController(
	...
	utilruntime.Must(networkscheme.AddToScheme(networkscheme.Scheme))
	glog.V(4).Info("Creating event broadcaster")
	eventBroadcaster := record.NewBroadcaster()
	eventBroadcaster.StartLogging(glog.Infof)
	eventBroadcaster.StartRecordingToSink(&typedcorev1.EventSinkImpl{Interface: kubeclientset.CoreV1().Events("")})
	recorder := eventBroadcaster.NewRecorder(networkscheme.Scheme, corev1.EventSource{Component: controllerAgentName})
